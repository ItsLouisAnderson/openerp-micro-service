...
menuIconMap.set("HubIcon", <HubIcon />);
menuIconMap.set("LocalShippingIcon", <LocalShippingIcon />);
menuIconMap.set("LocalPostOfficeIcon", <LocalPostOfficeIcon />);
menuIconMap.set("RouteIcon", <RouteIcon />)
menuIconMap.set("MultipleStopIcon", <MultipleStopIcon />)
